...
--Bài B3 (15đ) — Debug HTML
    ...
    Lỗi 9: Dòng 20 — Mô tả lỗi: thuộc tính src phải để trong dấu "" — Cách sửa:            <img src="iphone.jpg">
                
    Lỗi 10: Dòng  22— Mô tả lỗi: thứ tự đóng thẻ không đúng , đây là giá tiền nên phải để trong thẻ strong— Cách sửa:
                đổi thẻ <b> thành thẻ <strong> và đóng thẻ đúng thứ tự
                <p>Giá: <strong>25.990.000đ</strong></p>

    Lỗi 11: Dòng 28,31 — Mô tả lỗi:lỗi semantic việc thiếu các thẻ phân vùng chức năng (<thead>, <tbody>, <tfoot>) không làm bảng bị lỗi hiển thị, nhưng nó làm giảm tính ngữ nghĩa (Semantic) và gây khó khăn cho các trình đọc màn hình — Cách sửa: thêm thẻ <thead> và thẻ đóng </thead>

    Lỗi 12: Dòng 29,30 — Mô tả lỗi: lỗi semantic ở thẻ <thead> trong thẻ <tr> là thẻ <th> — Cách sửa: đổi <td> thành <th>

    Lỗi 13: Dòng 32,35 — Mô tả lỗi:lỗi semantic việc thiếu các thẻ phân vùng chức năng (<thead>, <tbody>, <tfoot>) không làm bảng bị lỗi hiển thị, nhưng nó làm giảm tính ngữ nghĩa (Semantic) và gây khó khăn cho các trình đọc màn hình — Cách sửa: thêm thẻ <tbody> và thẻ đóng </tbody>

    Lỗi 14: Dòng 40,42  — Mô tả lỗi: lỗi semantic trong thẻ body không được chứa 2 thẻ <main> — Cách sửa: đổi thẻ <main> thành thẻ phù hợp <aside>

    Lỗi 15: Dòng 44 — Mô tả lỗi: lỗi syntax thiếu đóng thẻ  thiếu kí tự bản quyền — Cách sửa: sửa thành
            <p>&copy;Copyright 2026</p>
    Lỗi 16: Dòng 46 — Mô tả lỗi: lỗi syntax thiếu đóng thẻ <html> — Cách sửa: thêm đóng thẻ </html>
